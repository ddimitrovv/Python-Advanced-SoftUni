...
# You will be given that string expression on the first line in the form
# of numbers and operators separated with a single space from each other.
...
# Constrains
#     • When reaching an operator, it is certain that you will have a minimum of one number to evaluate
